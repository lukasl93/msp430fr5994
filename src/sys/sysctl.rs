...
impl<'a> SYSBSLIND_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: SYSBSLIND_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn sysbslind_0(self) -> &'a mut W {
        self.variant(SYSBSLIND_A::SYSBSLIND_0)
    }
    #[doc = "BSL entry sequence detected"]
    #[inline(always)]
    pub fn sysbslind_1(self) -> &'a mut W {
        self.variant(SYSBSLIND_A::SYSBSLIND_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
