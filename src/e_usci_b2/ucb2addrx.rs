#[doc = "Reader of register UCB2ADDRX"]
pub type R = crate::R<u16, super::UCB2ADDRX>;
#[doc = "Writer for register UCB2ADDRX"]
pub type W = crate::W<u16, super::UCB2ADDRX>;
#[doc = "Register UCB2ADDRX `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB2ADDRX {
    type Type = u16;
    #[inline(always)]
