#[doc = "Reader of register UCA2CTLW1"]
pub type R = crate::R<u16, super::UCA2CTLW1>;
#[doc = "Writer for register UCA2CTLW1"]
pub type W = crate::W<u16, super::UCA2CTLW1>;
#[doc = "Register UCA2CTLW1 `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA2CTLW1 {
    type Type = u16;
    #[inline(always)]
