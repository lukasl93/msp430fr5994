#[doc = "Reader of register UCB3I2COA1"]
pub type R = crate::R<u16, super::UCB3I2COA1>;
#[doc = "Writer for register UCB3I2COA1"]
pub type W = crate::W<u16, super::UCB3I2COA1>;
#[doc = "Register UCB3I2COA1 `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3I2COA1 {
    type Type = u16;
    #[inline(always)]
