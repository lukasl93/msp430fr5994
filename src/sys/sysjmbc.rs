...
impl<'a> JMBOUT0FG_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: JMBOUT0FG_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn jmbout0fg_0(self) -> &'a mut W {
        self.variant(JMBOUT0FG_A::JMBOUT0FG_0)
    }
    #[doc = "JMBO0 is ready to receive new data"]
    #[inline(always)]
    pub fn jmbout0fg_1(self) -> &'a mut W {
        self.variant(JMBOUT0FG_A::JMBOUT0FG_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> JMBOUT1FG_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: JMBOUT1FG_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn jmbout1fg_0(self) -> &'a mut W {
        self.variant(JMBOUT1FG_A::JMBOUT1FG_0)
    }
    #[doc = "JMBO1 is ready to receive new data"]
    #[inline(always)]
    pub fn jmbout1fg_1(self) -> &'a mut W {
        self.variant(JMBOUT1FG_A::JMBOUT1FG_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
