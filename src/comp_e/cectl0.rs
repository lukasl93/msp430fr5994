...
impl CEIPEN_R {
    ...
    pub fn variant(&self) -> CEIPEN_A {
        match self.bits {
            false => CEIPEN_A::DISABLE,
            true => CEIPEN_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == CEIPEN_A::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == CEIPEN_A::ENABLE
    }
}
...
impl CEIMEN_R {
    ...
    pub fn variant(&self) -> CEIMEN_A {
        match self.bits {
            false => CEIMEN_A::DISABLE,
            true => CEIMEN_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == CEIMEN_A::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == CEIMEN_A::ENABLE
    }
}
...
impl<'a> CEIMEN_W<'a> {
    ...
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(CEIMEN_A::DISABLE)
    }
    #[doc = "Selected analog input channel for V- terminal is enabled"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(CEIMEN_A::ENABLE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
