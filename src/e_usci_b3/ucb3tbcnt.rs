#[doc = "Reader of register UCB3TBCNT"]
pub type R = crate::R<u16, super::UCB3TBCNT>;
#[doc = "Writer for register UCB3TBCNT"]
pub type W = crate::W<u16, super::UCB3TBCNT>;
#[doc = "Register UCB3TBCNT `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3TBCNT {
    type Type = u16;
    #[inline(always)]
