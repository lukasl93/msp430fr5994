...
impl<'a> CEIE_W<'a> {
    ...
    pub fn disable(self) -> &'a mut W {
        self.variant(CEIE_A::DISABLE)
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(CEIE_A::ENABLE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> CEIIE_W<'a> {
    ...
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(CEIIE_A::DISABLE)
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(CEIIE_A::ENABLE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl CERDYIE_R {
    ...
    pub fn variant(&self) -> CERDYIE_A {
        match self.bits {
            false => CERDYIE_A::DISABLE,
            true => CERDYIE_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == CERDYIE_A::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == CERDYIE_A::ENABLE
    }
}
...
impl<'a> CERDYIE_W<'a> {
    ...
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(CERDYIE_A::DISABLE)
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(CERDYIE_A::ENABLE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
