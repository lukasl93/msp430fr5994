#[doc = "Reader of register UCB2STATW_SPI"]
pub type R = crate::R<u16, super::UCB2STATW_SPI>;
#[doc = "Writer for register UCB2STATW_SPI"]
pub type W = crate::W<u16, super::UCB2STATW_SPI>;
#[doc = "Register UCB2STATW_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB2STATW_SPI {
    type Type = u16;
    #[inline(always)]
