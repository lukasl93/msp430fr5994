#[doc = "Reader of register UCB3CTLW1"]
pub type R = crate::R<u16, super::UCB3CTLW1>;
#[doc = "Writer for register UCB3CTLW1"]
pub type W = crate::W<u16, super::UCB3CTLW1>;
#[doc = "Register UCB3CTLW1 `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3CTLW1 {
    type Type = u16;
    #[inline(always)]
...
impl UCASTP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, UCASTP_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(UCASTP_A::UCASTP_0),
            1 => Val(UCASTP_A::UCASTP_1),
            2 => Val(UCASTP_A::UCASTP_2),
            i => Res(i),
        }
    }
