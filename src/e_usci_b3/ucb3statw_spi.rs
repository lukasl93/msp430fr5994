#[doc = "Reader of register UCB3STATW_SPI"]
pub type R = crate::R<u16, super::UCB3STATW_SPI>;
#[doc = "Writer for register UCB3STATW_SPI"]
pub type W = crate::W<u16, super::UCB3STATW_SPI>;
#[doc = "Register UCB3STATW_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3STATW_SPI {
    type Type = u16;
    #[inline(always)]
