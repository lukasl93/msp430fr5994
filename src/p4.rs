...
pub struct RegisterBlock {
    _reserved0: [u8; 33usize],
    #[doc = "0x21 - Port 4 Input"]
    pub p4in: P4IN,
    _reserved1: [u8; 1usize],
    #[doc = "0x23 - Port 4 Output"]
    pub p4out: P4OUT,
    _reserved2: [u8; 1usize],
    #[doc = "0x25 - Port 4 Direction"]
    pub p4dir: P4DIR,
    _reserved3: [u8; 1usize],
    #[doc = "0x27 - Port 4 Resistor Enable"]
    pub p4ren: P4REN,
    _reserved4: [u8; 3usize],
    #[doc = "0x2b - Port 4 Select 0"]
    pub p4sel0: P4SEL0,
    _reserved5: [u8; 1usize],
    #[doc = "0x2d - Port 4 Select 1"]
    pub p4sel1: P4SEL1,
    _reserved6: [u8; 9usize],
    #[doc = "0x37 - Port 4 Complement Select"]
    pub p4selc: P4SELC,
    _reserved7: [u8; 1usize],
    #[doc = "0x39 - Port 4 Interrupt Edge Select"]
    pub p4ies: P4IES,
    _reserved8: [u8; 1usize],
    #[doc = "0x3b - Port 4 Interrupt Enable"]
    pub p4ie: P4IE,
    _reserved9: [u8; 1usize],
    #[doc = "0x3d - Port 4 Interrupt Flag"]
    pub p4ifg: P4IFG,
