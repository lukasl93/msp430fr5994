#[doc = "Reader of register UCA3CTLW0_SPI"]
pub type R = crate::R<u16, super::UCA3CTLW0_SPI>;
#[doc = "Writer for register UCA3CTLW0_SPI"]
pub type W = crate::W<u16, super::UCA3CTLW0_SPI>;
#[doc = "Register UCA3CTLW0_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA3CTLW0_SPI {
    type Type = u16;
    #[inline(always)]
...
impl UCSSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, UCSSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(UCSSEL_A::UCSSEL_0),
            1 => Val(UCSSEL_A::ACLK),
            2 => Val(UCSSEL_A::SMCLK),
            i => Res(i),
        }
    }
...
impl UCMODE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, UCMODE_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(UCMODE_A::UCMODE_0),
            1 => Val(UCMODE_A::UCMODE_1),
            2 => Val(UCMODE_A::UCMODE_2),
            i => Res(i),
        }
    }
