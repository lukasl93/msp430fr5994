...
pub struct RegisterBlock {
    _reserved0: [u8; 97usize],
    #[doc = "0x61 - Port 8 Input"]
    pub p8in: P8IN,
    _reserved1: [u8; 1usize],
    #[doc = "0x63 - Port 8 Output"]
    pub p8out: P8OUT,
    _reserved2: [u8; 1usize],
    #[doc = "0x65 - Port 8 Direction"]
    pub p8dir: P8DIR,
    _reserved3: [u8; 1usize],
    #[doc = "0x67 - Port 8 Resistor Enable"]
    pub p8ren: P8REN,
    _reserved4: [u8; 3usize],
    #[doc = "0x6b - Port 8 Select 0"]
    pub p8sel0: P8SEL0,
    _reserved5: [u8; 1usize],
    #[doc = "0x6d - Port 8 Select 1"]
    pub p8sel1: P8SEL1,
    _reserved6: [u8; 9usize],
    #[doc = "0x77 - Port 8 Complement Select"]
    pub p8selc: P8SELC,
    _reserved7: [u8; 1usize],
    #[doc = "0x79 - Port 8 Interrupt Edge Select"]
    pub p8ies: P8IES,
    _reserved8: [u8; 1usize],
    #[doc = "0x7b - Port 8 Interrupt Enable"]
    pub p8ie: P8IE,
    _reserved9: [u8; 1usize],
    #[doc = "0x7d - Port 8 Interrupt Flag"]
    pub p8ifg: P8IFG,
...
#[doc = "Port 8 Select 0"]
pub mod p8sel0;
#[doc = "Port 8 Select 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p8sel1](p8sel1) module"]
...
#[doc = "Port 8 Select 1"]
pub mod p8sel1;
#[doc = "Port 8 Complement Select\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p8selc](p8selc) module"]
...
#[doc = "Port 8 Complement Select"]
pub mod p8selc;
#[doc = "Port 8 Interrupt Edge Select\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p8ies](p8ies) module"]
...
#[doc = "Port 8 Interrupt Edge Select"]
pub mod p8ies;
#[doc = "Port 8 Interrupt Enable\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p8ie](p8ie) module"]
...
#[doc = "Port 8 Interrupt Enable"]
pub mod p8ie;
#[doc = "Port 8 Interrupt Flag\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p8ifg](p8ifg) module"]
