#[doc = "Reader of register UCB2TBCNT"]
pub type R = crate::R<u16, super::UCB2TBCNT>;
#[doc = "Writer for register UCB2TBCNT"]
pub type W = crate::W<u16, super::UCB2TBCNT>;
#[doc = "Register UCB2TBCNT `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB2TBCNT {
    type Type = u16;
    #[inline(always)]
