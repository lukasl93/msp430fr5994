...
pub struct RegisterBlock {
    ...
    #[doc = "0x60 - Port 7 Input"]
    pub p7in: P7IN,
    _reserved1: [u8; 1usize],
    #[doc = "0x62 - Port 7 Output"]
    pub p7out: P7OUT,
    _reserved2: [u8; 1usize],
    #[doc = "0x64 - Port 7 Direction"]
    pub p7dir: P7DIR,
    _reserved3: [u8; 1usize],
    #[doc = "0x66 - Port 7 Resistor Enable"]
    pub p7ren: P7REN,
    _reserved4: [u8; 3usize],
    #[doc = "0x6a - Port 7 Select 0"]
    pub p7sel0: P7SEL0,
    _reserved5: [u8; 1usize],
    #[doc = "0x6c - Port 7 Select 1"]
    pub p7sel1: P7SEL1,
    _reserved6: [u8; 1usize],
    #[doc = "0x6e - Port 7 Interrupt Vector Register"]
    pub p7iv: P7IV,
    _reserved7: [u8; 6usize],
    #[doc = "0x76 - Port 7 Complement Select"]
    pub p7selc: P7SELC,
    _reserved8: [u8; 1usize],
    #[doc = "0x78 - Port 7 Interrupt Edge Select"]
    pub p7ies: P7IES,
    _reserved9: [u8; 1usize],
    #[doc = "0x7a - Port 7 Interrupt Enable"]
    pub p7ie: P7IE,
    _reserved10: [u8; 1usize],
    #[doc = "0x7c - Port 7 Interrupt Flag"]
    pub p7ifg: P7IFG,
}
...
#[doc = "Port 7 Complement Select"]
pub mod p7selc;
#[doc = "Port 7 Interrupt Edge Select\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p7ies](p7ies) module"]
...
#[doc = "Port 7 Interrupt Edge Select"]
pub mod p7ies;
#[doc = "Port 7 Interrupt Enable\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p7ie](p7ie) module"]
...
#[doc = "Port 7 Interrupt Enable"]
pub mod p7ie;
#[doc = "Port 7 Interrupt Flag\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p7ifg](p7ifg) module"]
