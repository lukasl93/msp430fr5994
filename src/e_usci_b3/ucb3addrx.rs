#[doc = "Reader of register UCB3ADDRX"]
pub type R = crate::R<u16, super::UCB3ADDRX>;
#[doc = "Writer for register UCB3ADDRX"]
pub type W = crate::W<u16, super::UCB3ADDRX>;
#[doc = "Register UCB3ADDRX `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3ADDRX {
    type Type = u16;
    #[inline(always)]
