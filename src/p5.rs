...
pub struct RegisterBlock {
    ...
    #[doc = "0x40 - Port 5 Input"]
    pub p5in: P5IN,
    _reserved1: [u8; 1usize],
    #[doc = "0x42 - Port 5 Output"]
    pub p5out: P5OUT,
    _reserved2: [u8; 1usize],
    #[doc = "0x44 - Port 5 Direction"]
    pub p5dir: P5DIR,
    _reserved3: [u8; 1usize],
    #[doc = "0x46 - Port 5 Resistor Enable"]
    pub p5ren: P5REN,
    _reserved4: [u8; 3usize],
    #[doc = "0x4a - Port 5 Select 0"]
    pub p5sel0: P5SEL0,
    _reserved5: [u8; 1usize],
    #[doc = "0x4c - Port 5 Select 1"]
    pub p5sel1: P5SEL1,
    _reserved6: [u8; 1usize],
    #[doc = "0x4e - Port 5 Interrupt Vector Register"]
    pub p5iv: P5IV,
    _reserved7: [u8; 6usize],
    #[doc = "0x56 - Port 5 Complement Select"]
    pub p5selc: P5SELC,
    _reserved8: [u8; 1usize],
    #[doc = "0x58 - Port 5 Interrupt Edge Select"]
    pub p5ies: P5IES,
    _reserved9: [u8; 1usize],
    #[doc = "0x5a - Port 5 Interrupt Enable"]
    pub p5ie: P5IE,
    _reserved10: [u8; 1usize],
    #[doc = "0x5c - Port 5 Interrupt Flag"]
    pub p5ifg: P5IFG,
}
...
#[doc = "Port 5 Complement Select"]
pub mod p5selc;
#[doc = "Port 5 Interrupt Edge Select\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p5ies](p5ies) module"]
...
#[doc = "Port 5 Interrupt Edge Select"]
pub mod p5ies;
#[doc = "Port 5 Interrupt Enable\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p5ie](p5ie) module"]
...
#[doc = "Port 5 Interrupt Enable"]
pub mod p5ie;
#[doc = "Port 5 Interrupt Flag\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p5ifg](p5ifg) module"]
