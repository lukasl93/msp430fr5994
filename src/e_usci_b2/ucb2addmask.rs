#[doc = "Reader of register UCB2ADDMASK"]
pub type R = crate::R<u16, super::UCB2ADDMASK>;
#[doc = "Writer for register UCB2ADDMASK"]
pub type W = crate::W<u16, super::UCB2ADDMASK>;
#[doc = "Register UCB2ADDMASK `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB2ADDMASK {
    type Type = u16;
    #[inline(always)]
