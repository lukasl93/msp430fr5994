...
impl From<CAPTIOPISEL0_A> for u8 {
    #[inline(always)]
    fn from(variant: CAPTIOPISEL0_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `CAPTIOPISEL0`"]
pub type CAPTIOPISEL0_R = crate::R<u8, CAPTIOPISEL0_A>;
impl CAPTIOPISEL0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CAPTIOPISEL0_A {
        match self.bits {
            0 => CAPTIOPISEL0_A::CAPTIOPISEL_0,
            1 => CAPTIOPISEL0_A::CAPTIOPISEL_1,
            2 => CAPTIOPISEL0_A::CAPTIOPISEL_2,
            3 => CAPTIOPISEL0_A::CAPTIOPISEL_3,
            4 => CAPTIOPISEL0_A::CAPTIOPISEL_4,
            5 => CAPTIOPISEL0_A::CAPTIOPISEL_5,
            6 => CAPTIOPISEL0_A::CAPTIOPISEL_6,
            7 => CAPTIOPISEL0_A::CAPTIOPISEL_7,
            _ => unreachable!(),
        }
    }
...
impl<'a> CAPTIOPISEL0_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: CAPTIOPISEL0_A) -> &'a mut W {
        {
    ...
    pub fn captiopisel_0(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_0)
    }
    #[doc = "Px.1"]
    #[inline(always)]
    pub fn captiopisel_1(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_1)
    }
    #[doc = "Px.2"]
    #[inline(always)]
    pub fn captiopisel_2(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_2)
    }
    #[doc = "Px.3"]
    #[inline(always)]
    pub fn captiopisel_3(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_3)
    }
    #[doc = "Px.4"]
    #[inline(always)]
    pub fn captiopisel_4(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_4)
    }
    #[doc = "Px.5"]
    #[inline(always)]
    pub fn captiopisel_5(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_5)
    }
    #[doc = "Px.6"]
    #[inline(always)]
    pub fn captiopisel_6(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_6)
    }
    #[doc = "Px.7"]
    #[inline(always)]
    pub fn captiopisel_7(self) -> &'a mut W {
        self.variant(CAPTIOPISEL0_A::CAPTIOPISEL_7)
    }
...
impl From<CAPTIOPOSEL0_A> for u8 {
    #[inline(always)]
    fn from(variant: CAPTIOPOSEL0_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `CAPTIOPOSEL0`"]
pub type CAPTIOPOSEL0_R = crate::R<u8, CAPTIOPOSEL0_A>;
impl CAPTIOPOSEL0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> CAPTIOPOSEL0_A {
        match self.bits {
            0 => CAPTIOPOSEL0_A::PJ,
            1 => CAPTIOPOSEL0_A::P1,
            2 => CAPTIOPOSEL0_A::P2,
            ...
            8 => CAPTIOPOSEL0_A::P8,
            9 => CAPTIOPOSEL0_A::P9,
            10 => CAPTIOPOSEL0_A::P10,
            11 => CAPTIOPOSEL0_A::P11,
            12 => CAPTIOPOSEL0_A::P12,
            13 => CAPTIOPOSEL0_A::P13,
            14 => CAPTIOPOSEL0_A::P14,
            15 => CAPTIOPOSEL0_A::P15,
            _ => unreachable!(),
        }
    }
...
impl<'a> CAPTIOPOSEL0_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CAPTIOPOSEL0_A) -> &'a mut W {
        {
            self.bits(variant.into())
        }
    }
    ...
    pub fn pj(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::PJ)
    }
    #[doc = "Px = P1"]
    #[inline(always)]
    pub fn p1(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P1)
    }
    #[doc = "Px = P2"]
    #[inline(always)]
    pub fn p2(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P2)
    }
    #[doc = "Px = P3"]
    #[inline(always)]
    pub fn p3(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P3)
    }
    #[doc = "Px = P4"]
    #[inline(always)]
    pub fn p4(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P4)
    }
    #[doc = "Px = P5"]
    #[inline(always)]
    pub fn p5(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P5)
    }
    #[doc = "Px = P6"]
    #[inline(always)]
    pub fn p6(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P6)
    }
    #[doc = "Px = P7"]
    #[inline(always)]
    pub fn p7(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P7)
    }
    #[doc = "Px = P8"]
    #[inline(always)]
    pub fn p8(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P8)
    }
    #[doc = "Px = P9"]
    #[inline(always)]
    pub fn p9(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P9)
    }
    #[doc = "Px = P10"]
    #[inline(always)]
    pub fn p10(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P10)
    }
    #[doc = "Px = P11"]
    #[inline(always)]
    pub fn p11(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P11)
    }
    #[doc = "Px = P12"]
    #[inline(always)]
    pub fn p12(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P12)
    }
    #[doc = "Px = P13"]
    #[inline(always)]
    pub fn p13(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P13)
    }
    #[doc = "Px = P14"]
    #[inline(always)]
    pub fn p14(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P14)
    }
    #[doc = "Px = P15"]
    #[inline(always)]
    pub fn p15(self) -> &'a mut W {
        self.variant(CAPTIOPOSEL0_A::P15)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
Capacitive Touch IO pin select"]
    ...
    pub fn captiopisel0(&self) -> CAPTIOPISEL0_R {
        CAPTIOPISEL0_R::new(((self.bits >> 1) & 0x07) as u8)
    }
    #[doc = "Bits 4:7 - 7:4\\]
Capacitive Touch IO port select"]
    #[inline(always)]
    pub fn captioposel0(&self) -> CAPTIOPOSEL0_R {
        CAPTIOPOSEL0_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bit 8 - 8:8\\]
Capacitive Touch IO enable"]
    #[inline(always)]
