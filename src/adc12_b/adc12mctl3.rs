#[doc = "Reader of register ADC12MCTL3"]
pub type R = crate::R<u16, super::ADC12MCTL3>;
#[doc = "Writer for register ADC12MCTL3"]
pub type W = crate::W<u16, super::ADC12MCTL3>;
#[doc = "Register ADC12MCTL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC12MCTL3 {
    type Type = u16;
    #[inline(always)]
