#[doc = "Reader of register UCB3ADDMASK"]
pub type R = crate::R<u16, super::UCB3ADDMASK>;
#[doc = "Writer for register UCB3ADDMASK"]
pub type W = crate::W<u16, super::UCB3ADDMASK>;
#[doc = "Register UCB3ADDMASK `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB3ADDMASK {
    type Type = u16;
    #[inline(always)]
